...
def Base(key: str):
    ...
    class Base:
        ...
        def make_key(cls, part: str):
            """
            This is a class method that returns a Redis key by concatenating the model prefix and the given part. The model prefix is obtained from the class's meta attribute 'model_key_prefix'. If the attribute is not present, an empty string is used as the prefix. The prefix is stripped of any colons before concatenation with the part.
            """
